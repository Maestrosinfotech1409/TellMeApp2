...
const IsSplashOnlySolidColor = true;
const SplashBackgroundSolidColor = Color(0xFFFFFFFF); //applies this colors if "IsSplashOnlySolidColor" is set to true. Color Code: 0xFF005f56 for Whatsapp theme & 0xFFFFFFFF for messenger theme.
...
const Agora_APP_IDD =
    '4b14fd72f0624494949d0c931a88a5f4'; // Grab it from: https://www.agora.io/en/
...
const GiphyAPIKey =
    'H2b32dDD3OHqPzCLEucHcQQBlF7DSsgB'; // Grab it from: https://developers.giphy.com/

//*--App Configurations---
const Appname =
    'Tellapp'; //app name shown evrywhere with the app where required
